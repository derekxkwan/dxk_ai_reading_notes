...
year: 2022
tags: ["music theory", "formal analysis (music)", "structure labeling (music)", "neural network architecture development", "convolutional", "popular music", "pop", "transformer", "music", "cnn", "non-bar/beat aligned similarity", "music boundary", "audio", "boundary detection (music)"]
