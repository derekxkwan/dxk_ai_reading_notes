...
## Key Contributions
Overview of work on BIC (one likelihood) and applications (Bayes ratio approx, posterior probability recovery, model averaging).
